...
import { View, Text, ScrollView, TouchableOpacity, Dimensions, Animated, Modal } from "react-native";
        ...
        <View style = {{paddingHorizontal:20}}>
            ...
            {true? (
                <View style = {styles.emptyState}>
                    ...
                    <Text style ={styles.emptyStateText}> No medication scheduled today</Text>
                        ...
                        <View style = {styles.doseCard}>
                          ...
                          //  }
                            ...
                            <View style = {styles.doseInfo}>
                                <View>
                                <Text style = {styles.medicineName}>medicationsname</Text>
                                <Text style = {styles.dosageInfo}>medicationstime</Text>
                                 </View>
